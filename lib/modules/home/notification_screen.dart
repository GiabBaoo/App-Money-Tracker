                  ...
                  builder: (context, snapshot) {
                    ...
                    if (notifications.isEmpty) {
                      return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        const Text('Chưa có thông báo nào', style: TextStyle(color: Color(0xFF999999), fontSize: 16)),
                      ]));
                    }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: notification.isRead ? const Color(0xFFF9FAFB) : const Color(0xFFE8F5F0),
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            width: 50, height: 50,
            decoration: BoxDecoration(
              color: notification.isRead ? const Color(0xFFE5E7EB) : const Color(0xFFFEF3C7),
              borderRadius: BorderRadius.circular(16),
            ),
            child: Icon(notification.icon, color: notification.isRead ? const Color(0xFF6B7280) : const Color(0xFFF59E0B), size: 28),
          ),
          const SizedBox(width: 16),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(notification.title, style: TextStyle(color: const Color(0xFF1F2937), fontSize: 16, fontWeight: notification.isRead ? FontWeight.w400 : FontWeight.w600)),
            const SizedBox(height: 4),
            Text(notification.description, style: const TextStyle(color: Color(0xFF6B7280), fontSize: 14, height: 1.4)),
          ])),
          if (!notification.isRead)
