                            ...
                            child: Column(
                              children: [
                                ...
                                _buildSecurityItem(
                                  ...
                                  subtitle: 'Quản lý các phiên đăng nhập',
                                  showDivider: false,
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Tài khoản an toàn', 
                    style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
                const SizedBox(height: 4),
                Text('Cập nhật mật khẩu thường xuyên để tăng tính bảo mật.',
      ...
      builder: (context) {
        ...
        return Column(
          children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(title, style: TextStyle(color: isDark ? Colors.white : const Color(0xFF333333), fontSize: 16, fontWeight: FontWeight.w600)),
                          const SizedBox(height: 4),
                          Text(subtitle, style: TextStyle(color: isDark ? Colors.white70 : const Color(0xFF888888), fontSize: 14)),
                        ],
                      ),
                    ),
            ...
            if (showDivider)
              Divider(height: 1, color: isDark ? const Color(0xFF3E3E3E) : Colors.grey.shade100, indent: 64, endIndent: 16),
          ],
        );
      }
    );
