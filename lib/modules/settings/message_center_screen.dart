                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    _buildMessageItem(
                      ...
                      fullMessage:
                          'Chào bạn,\n\nYêu cầu hỗ trợ của bạn đã được gửi đến bộ phận Chăm sóc khách hàng. Tư vấn viên của chúng tôi sẽ liên hệ lại với bạn trong vòng 24 giờ tới.\n\nTrân trọng!',
                      time: 'Hôm qua',
                      isUnread: false,
                    ),
                    _buildDivider(),
