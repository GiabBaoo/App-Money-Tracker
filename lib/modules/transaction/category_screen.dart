...
class _CategoryScreenState extends State<CategoryScreen> {
  ...
  final List<IconData> _allIcons = [
    ...
    Icons.flight_outlined, Icons.favorite_outline, Icons.work_outline,
    Icons.bar_chart_outlined, Icons.card_giftcard_outlined, Icons.storefront_outlined,
    Icons.account_balance_wallet_outlined, Icons.savings_outlined, Icons.payments_outlined,
    Icons.trending_up_outlined, Icons.monetization_on_outlined, Icons.redeem_outlined,
  ];
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> defaultIncomeList = [
      {'name': 'Tiền lương', 'icon': Icons.bar_chart_outlined},
                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            _buildTabItem('Khoản Chi', !_isIncomeTab),
                            _buildTabItem('Khoản Thu', _isIncomeTab),
                          ],
                        ),
                      ),
                    ),
  ...
  Widget _buildTabItem(String title, bool isSelected) {
    return Expanded(
      child: GestureDetector(
        onTap: () => setState(() => _isIncomeTab = title == 'Khoản Thu'),
        child: Container(
  ...
  void _showAddCategoryDialog(BuildContext context) {
    ...
    IconData tempSelectedIcon = _allIcons[0];
