...
class JoinGroupScreen extends ConsumerStatefulWidget {
  ...
  const JoinGroupScreen({super.key, required this.groupId, this.notificationId});
  ...
  Future<void> _joinGroup() async {
    ...
    try {
      ...
      await _sendNotificationToAdmin(
        ...
        description: '$userName đã chấp nhận lời mời tham gia quỹ "${group.name}"',
      ...
      print('DEBUG ERROR in _joinGroup: $e');
      setState(() {
        _errorMessage = 'Lỗi: $e';
        _isJoining = false;
      });
                            ...
                            children: [
                              ...
                              FutureBuilder<DocumentSnapshot>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final adminAvatar = adminData['avatarUrl'] as String?;
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: _buildStatCard(
                                      ...
                                      label: 'Tạo vào',
                                      value: '${group.createdAt.day}/${group.createdAt.month}/${group.createdAt.year}',
                                      color: groupColor,
                                    ),
                                  ),
                                ],
                  ...
                  child: Container(
                    ...
                    child: _isAccepted || _isRejected
                      ? Container(
                          ...
                          decoration: BoxDecoration(
                            color: _isAccepted ? Colors.green.withOpacity(0.1) : Colors.red.withOpacity(0.1),
                            borderRadius: BorderRadius.circular(12),
                            border: Border.all(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                _isAccepted ? 'Bạn đã chấp nhận lời mời' : 'Bạn đã từ chối lời mời',
                                style: TextStyle(
                                  color: _isAccepted ? Colors.green : Colors.red,
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                          ...
                          children: [
                            ...
                            Expanded(
                              child: OutlinedButton(
                                onPressed: _isRejecting || _isJoining ? null : () => _rejectInvitation(group.name, group.adminId),
                                ...
                                child: _isRejecting
                                  ...
                                  : Text(
                                      'Từ chối',
                                      style: TextStyle(
                                        color: Colors.red.withOpacity(_isRejecting ? 0.5 : 0.8),
                                        fontSize: 16,
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
                            ...
                            Expanded(
                              child: ElevatedButton(
                                onPressed: _isJoining || _isRejecting ? null : _joinGroup,
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: groupColor,
                                  padding: const EdgeInsets.symmetric(vertical: 14),
                                  shape: RoundedRectangleBorder(
